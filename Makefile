...
SUFFIX="-dev"# E.g.: SUFFIX="dev" --> "mscore" becomes "mscoredev"
LABEL="Development"# E.g.: LABEL="Development Build" --> "MuseScore 2" becomes "MuseScore 2 Development Build"
